...
// DDS Msg TypeSupportMetaHolder Object Body
MsgTypeSupportMetaHolder::MsgTypeSupportMetaHolder () :
        DDS::OpenSplice::TypeSupportMetaHolder ("Msg", "", "userID")
{
    copyIn = (DDS::OpenSplice::cxxCopyIn) __Msg__copyIn;
    copyOut = (DDS::OpenSplice::cxxCopyOut) __Msg__copyOut;
    metaDescriptorArrLength = 2;
    metaDescriptorLength = 152;
    const char *tmp[] = {"<MetaData version=\"1.0.0\"><Struct name=\"Msg\"><Member name=\"userID\"><Long/></Member><Member name=\"message\">",
...
MsgTypeSupportMetaHolder::create_datawriter ()
{
    return new MsgDataWriter_impl();
}

::DDS::OpenSplice::DataReader *
MsgTypeSupportMetaHolder::create_datareader ()
{
    return new MsgDataReader_impl();
}

::DDS::OpenSplice::DataReaderView *
MsgTypeSupportMetaHolder::create_view ()
{
    return new MsgDataReaderView_impl();
}
...
{
    tsMetaHolder = new MsgTypeSupportMetaHolder();
}
...
::DDS::InstanceHandle_t
MsgDataWriter_impl::register_instance_w_timestamp (
...
::DDS::ReturnCode_t
MsgDataWriter_impl::unregister_instance_w_timestamp (
    const Msg & instance_data,
...
::DDS::ReturnCode_t
MsgDataWriter_impl::write_w_timestamp (
    const Msg & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MsgDataWriter_impl::dispose_w_timestamp (
    const Msg & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MsgDataWriter_impl::writedispose (
    const Msg & instance_data,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MsgDataWriter_impl::writedispose_w_timestamp (
    const Msg & instance_data,
    ::DDS::InstanceHandle_t handle,
    const ::DDS::Time_t & source_timestamp) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MsgDataWriter_impl::get_key_value (
    Msg & key_holder,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::InstanceHandle_t
MsgDataWriter_impl::lookup_instance (
    const Msg & instance_data) THROW_ORB_EXCEPTIONS
{
        ...
        if ( received_data.length() > 0 ) {
            if (received_data.length() == info_seq.length() &&
                ...
                if (!received_data.release()) {
                    ...
                    if ( result == ::DDS::RETCODE_OK ) {
                        if ( !received_data.release() ) {
                            MsgSeq::freebuf( received_data.get_buffer(false) );
...
void *
MsgDataReader_impl::dataSeqAlloc (
    void * received_data,
    DDS::ULong len)
{
    MsgSeq *data_seq = reinterpret_cast<MsgSeq *>(received_data);
    data_seq->replace(len, len, data_seq->allocbuf(len), false);
    return data_seq->get_buffer();
}

void *
MsgDataReader_impl::dataSeqGetBuffer (
    void * received_data,
    DDS::ULong index)
{
	MsgSeq *data_seq = reinterpret_cast<MsgSeq *>(received_data);
...
void
MsgDataReader_impl::dataSeqLength (
    void * received_data,
    DDS::ULong len)
{
    MsgSeq *data_seq = reinterpret_cast<MsgSeq *>(received_data);
...
void
MsgDataReader_impl::dataSeqCopyOut (
    const void * from,
    void * to)
{
    Msg *data = reinterpret_cast<Msg *>(to);
    __Msg__copyOut(from, data);
}

void
MsgDataReader_impl::copyDataOut (
    const void * from,
    void * to)
{
    Msg *data = reinterpret_cast<Msg *>(to);
...
// DDS Msg DataReaderView_impl Object Body
MsgDataReaderView_impl::MsgDataReaderView_impl ()
{
    // Parent constructor takes care of everything.
}
    ...
    DDS::OpenSplice::cxxCopyOut copyOut)
{
    return DDS::OpenSplice::FooDataReaderView_impl::nlReq_init(
            reader, name, qos, copyIn, copyOut, MsgDataReader_impl::dataSeqAlloc,
            MsgDataReader_impl::dataSeqLength);
}

::DDS::ReturnCode_t
MsgDataReaderView_impl::read (
    MsgSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::SampleStateMask sample_states,
    ...
    ::DDS::InstanceStateMask instance_states) THROW_ORB_EXCEPTIONS
{
    ...
    status = MsgDataReader_impl::check_preconditions(received_data, info_seq, max_samples);
    if ( status == ::DDS::RETCODE_OK ) {
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::read_w_condition (
    MsgSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition) THROW_ORB_EXCEPTIONS
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::take_w_condition (
    MsgSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::ReadCondition_ptr a_condition) THROW_ORB_EXCEPTIONS
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::read_next_sample (
    Msg & received_data,
    ::DDS::SampleInfo & sample_info) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::take_next_sample (
    Msg & received_data,
    ::DDS::SampleInfo & sample_info) THROW_ORB_EXCEPTIONS
{
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::read_instance (
    MsgSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::take_instance (
    MsgSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::read_next_instance (
    MsgSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::take_next_instance (
    MsgSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::read_next_instance_w_condition (
    MsgSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::take_next_instance_w_condition (
    MsgSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq,
    ::DDS::Long max_samples,
    ::DDS::InstanceHandle_t a_handle,
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::return_loan (
    MsgSeq & received_data,
    ::DDS::SampleInfoSeq & info_seq) THROW_ORB_EXCEPTIONS
{
    ::DDS::ReturnCode_t result = ::DDS::RETCODE_OK;
...
::DDS::ReturnCode_t
MsgDataReaderView_impl::get_key_value (
    Msg & key_holder,
    ::DDS::InstanceHandle_t handle) THROW_ORB_EXCEPTIONS
{
...
::DDS::InstanceHandle_t
MsgDataReaderView_impl::lookup_instance (
    const Msg & instance) THROW_ORB_EXCEPTIONS
{
