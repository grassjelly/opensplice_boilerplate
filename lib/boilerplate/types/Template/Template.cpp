...
TemplateMsg::Publisher::Publisher(Participant  &participant_object, char * topic_name)
{
...
void TemplateMsg::Publisher::init_publisher()
{
  ...
  /* Use the changed policy when defining the Template topic */
...
TemplateMsg::Subscriber::Subscriber(Participant  &participant_object, char * topic_name)
{
  participant = participant_object.get_participant();
  partition = participant_object.get_partition();
  topicName = topic_name;    
...
void TemplateMsg::Subscriber::init_subscriber()
{
...
void TemplateMsg::Subscriber::read()
{
...
void TemplateMsg::Subscriber::kill()
{
  //========delete reader==========
